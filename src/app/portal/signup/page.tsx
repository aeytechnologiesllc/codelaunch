            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="relative my-5">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-3 bg-bg-secondary text-text-muted">or</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-3 px-7 py-3 bg-white text-gray-800 font-medium rounded-xl hover:bg-gray-100 transition-all text-sm border border-gray-200"
              >
