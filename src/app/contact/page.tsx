          ...
          <ScrollReveal className="lg:col-span-3">
            <div className="glass-card p-8">
              <form className="space-y-6">
                ...
                <button type="submit" className="group w-full inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-accent text-bg-primary font-semibold rounded-xl glow-gold hover:bg-accent-hover transition-all">
