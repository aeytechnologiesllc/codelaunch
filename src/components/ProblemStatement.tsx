...
const problems = [
  {
    ...
    accentColor: "#f87171",
    hoverShadow: "group-hover:shadow-[0_0_40px_rgba(248,113,113,0.12)]",
  },
  {
    icon: Hourglass,
  ...
  },
  {
    ...
    accentColor: "#a78bfa",
    hoverShadow: "group-hover:shadow-[0_0_40px_rgba(167,139,250,0.12)]",
  },
];
            ...
            <ScrollReveal key={i} delay={i * 0.12} animation="slideLeft">
              <div className={`glass-card p-8 h-full hover:bg-white/[0.06] transition-all duration-500 group ${p.hoverShadow}`}>
                ...
                <div className="relative mb-8">
                  {/* Glow behind icon */}
                  <div
                    className="absolute -inset-3 rounded-3xl blur-2xl opacity-40 group-hover:opacity-70 transition-opacity duration-500"
                    style={{ background: p.accentColor }}
                  />
                  {/* Icon box */}
                  <div
                    className="relative w-14 h-14 rounded-2xl flex items-center justify-center border group-hover:scale-110 transition-transform duration-300"
                    style={{
                      background: `linear-gradient(135deg, ${p.accentColor}18 0%, ${p.accentColor}08 100%)`,
